...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketHandler::connected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SocketHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketHandler::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketHandler::received)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketHandler::sent)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketHandler::error)) {
                *result = 4;
                return;
            }
        }
...
void SocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketServer::clientConnected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SocketServer::*_t)(IOContext * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketServer::clientDisconnected)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SocketServer::*_t)(IOContext * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketServer::dataReceived)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketServer::error)) {
                *result = 3;
                return;
            }
        }
